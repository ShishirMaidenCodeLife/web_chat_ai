...
class UserMessageFE(BaseModel): 
    user_msg_fe: str

# It you use POST method from Web.
@app.post("/message")
async def read_item(message: UserMessageFE):
    global global_continue_past_session
    user_msg = message.user_msg_fe

# If you use Get method from VRChat.
